...
class MovieRepository {
    ...
    // ==========================================================
    // LẤY DANH SÁCH PHIM - PAGINATION + SEARCH
    // Dùng cho ADMIN
    // ==========================================================
    async findAll(page = 1, limit = 20, search = "") {
        ...
        // ------------------------------------------------------
        // XỬ LÝ SEARCH (Giống UserRepository)
        // ------------------------------------------------------
    ...
    // ==========================================================
    // LẤY PHIM THEO STATUS - PAGINATION + SEARCH
    // Dùng cho Frontend User (VD: Danh sách phim đang chiếu)
    // ==========================================================
    async findByStatus(status, page = 1, limit = 20, search = "") {
        ...
        if (search) {
            // Tìm kiếm theo tên phim hoặc đạo diễn trong cùng status
            searchClause = `
                AND (
                    m.title LIKE ?
                    OR m.director LIKE ?
        ...
        // Đếm tổng số phim theo status + search
        const [countRows] = await db.query(
            `
            SELECT COUNT(*) AS total
            FROM movies m
    ...
    // ==========================================================
    // LẤY PHIM THEO GENRE SLUG - PAGINATION + SEARCH
    // ==========================================================
    ...
    // ==========================================================
    // CÁC HÀM CÒN LẠI GIỮ NGUYÊN (Tìm theo ID, Slug, CRUD...)
    // ==========================================================
