// repositories/PromotionRepository.js
...
class PromotionRepository {
    ...
    =========================================================*/
    async create(data) {
        const { title, slug, description, promotion_image, promotion_backdrop, likes, is_active } = data;

        const [result] = await db.query(`
            INSERT INTO promotions
            (title, slug, description, promotion_image, promotion_backdrop, likes, views, is_active)
            VALUES (?, ?, ?, ?, ?, ?, 0, ?)
        `, [
            title.trim(),
            slug,
