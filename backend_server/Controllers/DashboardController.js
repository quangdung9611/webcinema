...
class DashboardController {
    ...
    static async getStats(req, res) {
        ...
        try {
            ...
            */
            ...
            const movieTotal =
                Number(movieTotalRes[0][0]?.total) || 0;

            const userTotal =
                Number(userTotalRes[0][0]?.total) || 0;
            ...
            return res.status(200).json({
                ...
                ticketRevenue:
                    Number(current.ticket_revenue) || 0,

                productRevenue:
                    Number(current.product_revenue) || 0,
    ...
    static async getRevenueTrend(req, res) {
        ...
        try {
            ...
            const range =
                DashboardController.getDateRange(
        ...
        try {
            ...
            return res.status(200).json({
                ...
                data: rows.map(row => ({
                    ...
                    ticketCount:
                        Number(row.ticketCount) || 0,
                    totalRevenue:
                        Number(row.ticketRevenue) || 0
                })),
    ...
    static async getContentStats(req, res) {
        ...
        try {
            ...
            return res.status(200).json({
                ...
                actors:
                    Number(actors[0][0]?.total) || 0,

                genres:
                    Number(genres[0][0]?.total) || 0,

                cinemas:
                    Number(cinemas[0][0]?.total) || 0,

                rooms:
                    Number(rooms[0][0]?.total) || 0,

                upcomingShowtimes:
                    Number(showtimes[0][0]?.total) || 0,
