...
class DashboardController {
    ...
    // =============================================================
    // 20. TỔNG HỢP NHANH CHO TRANG CHỦ ADMIN
    // =============================================================
    ...
    static async getSummary(req, res) {
        try {
            ...
            const [stats, topMovies, bookingStatus, seat] = await Promise.all([
                ...
                this._getSeatPerformanceInternal(range)
            ]);
