...
exports.getAllPromotionsAll = async (req, res) => {
    ...
    try {
        ...
        // /api/promotions không hỗ trợ page / limit
        if (
            page !== undefined ||
            limit !== undefined
        ) {
...
=========================================================*/
exports.getPromotionsWithPagination = async (
    req,
    res
) => {
    ...
    try {
        ...
        console.error(
            "Get Promotions Paginated Error:",
            err
        );
...
=========================================================*/
exports.getPromotionBySlug = async (
    req,
    res
) => {
    ...
    try {
        ...
        const promotion =
            await PromotionService.getPromotionBySlug(
                slug
            );
...
exports.likePromotion = async (
    ...
    try {
        ...
        await PromotionService.likePromotion(
            promotion_id
        );
...
=========================================================*/
exports.togglePromotionStatus = async (
    req,
    res
) => {
    ...
    try {
        ...
        const isActive =
            await PromotionService.toggleStatus(
                promotion_id
            );
