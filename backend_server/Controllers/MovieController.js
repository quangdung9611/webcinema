...
exports.getMoviesWithPagination = async (req, res) => {
    try {
        ...
        const result = await MovieService.getAllMovies(page, limit, search);
...
exports.getMoviesByStatusSlug = async (req, res) => {
    try {
        ...
        const result = await MovieService.getMoviesByStatus(dbStatus, page, limit, search);
        return res.status(200).json({
            success: true,
            data: result.data,
            pagination: result.pagination
...
exports.getMoviesWithGenre = async (req, res) => {
    try {
        ...
        const result = await MovieService.getMoviesByGenre(genre, page, limit, search);
        return res.status(200).json({
            success: true,
            data: result.data,
            pagination: result.pagination
