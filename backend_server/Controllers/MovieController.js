...
const deleteFile = (
    ...
    try {
        ...
        if (
            ...
            console.log(
                `✅ Đã xóa file cũ trong ${subFolder}:`,
                pureFileName
            );
...
exports.updateMovie =
    ...
    try {
        ...
        if (
            ...
            const newBackdropName =
                files[
                    'backdrop_url'
                ][0].filename;

            // chỉ xóa nếu khác file cũ
            if (
                newBackdropName !==
                old[0]
                    .backdrop_url
...
exports.getMoviesByStatusGroup =
    async (req, res) => {
    ...
    try {
        ...
        return res
            ...
            .json({
                ...
                error:
                    "Lỗi hệ thống khi cập nhật lượt xem"
