...
exports.getAllUsers = async (req, res) => {
    ...
    try {
        ...
        // Không cho phép page / limit
        // trên API không phân trang
        if (
            page !== undefined ||
            limit !== undefined
        ) {
            ...
            return res.status(400).json({
                ...
                message:
                    "Route /api/users không hỗ trợ tham số page hoặc limit. Vui lòng sử dụng /api/users/paginated để phân trang."

            });
        }


        // UserService trả về trực tiếp rows[]
        const data =
            await UserService.getAllUsersAll(
                search
            );
