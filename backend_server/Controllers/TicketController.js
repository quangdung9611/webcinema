...
const getFilteredShowtimes = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            success: false,
            error:
                "Lỗi server khi lấy toàn bộ suất chiếu"
        });
