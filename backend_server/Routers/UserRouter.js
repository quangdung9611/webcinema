...
// GET: https://webcinema-zb8z.onrender.com/api/users/
router.get('/', userController.getAllUsers);

// 2. Thêm mới user (Admin tạo tài khoản cho nhân viên/khách hàng)
// POST: https://webcinema-zb8z.onrender.com/api/users/add
router.post('/add', userController.createUser);

// 3. Cập nhật thông tin user theo ID
// PUT: https://webcinema-zb8z.onrender.com/api/users/update/1
router.put('/update/:user_id', userController.updateUser);

// 4. Xóa user theo ID
// DELETE: https://webcinema-zb8z.onrender.com/api/users/delete/1
