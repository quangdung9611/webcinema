...
const ForgotPassword = () => {
    ...
    // Đồng bộ TTL từ Redis mỗi 1 giây
    useEffect(() => {
        if (step !== 'otp') return;
    ...
    const handleVerifyOtp = async () => {
        ...
        if (showLockModal) {
            setError('❌ OTP đã bị khóa. Vui lòng gửi lại OTP mới.');
            return;
        }
        ...
        try {
            ...
            if (status === 429) {
                ...
                if (remainingAttempts > 0) {
                    ...
                    setLockUntil(lockUntilTimestamp);
                    setIsRateLimited(true);
                    setRateLimitTimeLeft(lockDuration);
            ...
            <div className="auth-card">
                ...
                {step === 'otp' && (
                    <>
                        ...
                        {/* Hiển thị số lần thử còn lại (khi chưa bị khóa) */}
                        ...
                        {/* Hiển thị thông báo khi bị khóa do sai 5 lần */}
                        {showLockModal && (
                            <div style={{ 
                                textAlign: 'center', 
                                marginBottom: '10px',
                                ...
                                🔒 Bạn đã nhập sai 5 lần. Vui lòng đợi <strong>{formatLockTime(lockTimeLeft)}</strong> để thử lại.
                            </div>
                        )}
                        ...
                        {/* CHỈ HIỂN THỊ OTP TIMER KHI KHÔNG BỊ LOCK */}
                        ...
                        {/* HIỂN THỊ THỜI GIAN KHÓA KHI BỊ LOCK */}
                        {isLocked && (
                            <div className="input-hint center-text">
                                <span style={{ color: '#ff6b8a' }}>
