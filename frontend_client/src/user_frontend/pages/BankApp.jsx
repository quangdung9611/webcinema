...
const BankApp = () => {
    ...
    const clearAllBookingData = useCallback(() => {
        const keysToRemove = [
            ...
            'bankLastOtpSentAt', 'paymentInitiated', 'paymentCompleted',
    ...
    const cancelBookingOnServer = useCallback(async () => {
        ...
        try {
            if (isRescheduleMode) {
                ...
                console.log('✅ [BANK APP] Reschedule temp booking cancelled');
            } else {
    ...
    }, [tempBookingId, ownerToken, isRescheduleMode, rescheduleBookingId]);
    ...
    }, [cancelBookingOnServer, closeModal, openModal, invalidateOTP, safeNavigate, isRescheduleMode]);
    ...
    }, [customerEmail, tempBookingId, openModal, resetLockState, isRescheduleMode, rescheduleBookingId]);
