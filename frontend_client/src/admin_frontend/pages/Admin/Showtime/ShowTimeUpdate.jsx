...
const ShowtimeUpdate = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const [movieRes, cinemaRes, showtimeRes] = await Promise.all([
                    ...
                    axios.get(`http://localhost:5000/api/showtimes/detail/${showtime_id}`)
                ]);
                ...
                if (st) {
                    ...
                    const roomRes = await axios.get(`http://localhost:5000/api/rooms/cinema/${st.cinema_id}`);
    ...
    const handleCinemaChange = async (e) => {
        ...
        if (newCinemaId) {
            try {
                const res = await axios.get(`http://localhost:5000/api/rooms/cinema/${newCinemaId}`);
                setRooms(res.data);
            } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:5000/api/showtimes/update/${showtime_id}`, formData);
