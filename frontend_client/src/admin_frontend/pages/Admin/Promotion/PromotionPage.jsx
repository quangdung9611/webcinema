...
const API_URL =
    'https://api.quangdungcinema.id.vn/api/promotion';
...
const PromotionPage = () => {
    ...
    const handleOpenEdit = (
        ...
        setPreview(
            ...
            item.image_url
                ...
                ? `https://api.quangdungcinema.id.vn/uploads/promotions/${item.image_url}`
    ...
    const validateForm = () => {
        ...
        if (
            ...
            newErrors.title =
                'Tiêu đề phải từ 5 ký tự trở lên.';
        ...
        try {
            ...
            if (
                ...
                await axios.put(
                    ...
                    `${API_URL}/update/${editingPromotion.promotion_id}`,
...

        {
            ...
            render: (row) => (
                ...
                <img
                    ...
                    src={`https://api.quangdungcinema.id.vn/uploads/promotions/${row.image_url}`}
