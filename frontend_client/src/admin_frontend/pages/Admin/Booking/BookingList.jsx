...
const BookingList = () => {
    ...
    const fetchBookings = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://api.quangdungcinema.id.vn/api/bookings');
    ...
    const handleUpdateStatus = (booking_id, currentStatus) => {
        ...
        showModal(
            ...
            async () => {
                try {
                    await axios.put(`https://api.quangdungcinema.id.vn/api/bookings/update/${booking_id}/status`, { status: nextStatus });
                    fetchBookings(); 
    ...
    const handleDelete = (booking_id, memo) => {
        showModal(
            ...
            async () => {
                try {
                    await axios.delete(`https://api.quangdungcinema.id.vn/api/bookings/delete/${booking_id}`);
