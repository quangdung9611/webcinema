...
// =============================================================
//  API ENDPOINTS (prefix: /admin/api/dashboard)
// =============================================================
const API = {
...
function AdminDashboard() {
    ...
    // =============================================================
    //  Auto-fetch on period/date change
    // =============================================================
    useEffect(() => {
        fetchDashboard();
            ...
            <section className="dashboard-filter">
                ...
                {period === 'custom' && (
                    <div className="custom-date">
                        ...
                        />
                        <button onClick={handleCustomSubmit}>Áp dụng</button>
                    </div>
                )}
                ...
                <div className="current-period">
                    ...
                    <strong>
                        {stats.period?.startDate
                            ? `${formatDate(stats.period.startDate)} — ${formatDate(
            ...
            <section className="dashboard-grid grid-main">
                <div className="dashboard-card revenue-card">
                    ...
                    <div className="revenue-summary">
                        ...
                        <div>
                            <span>Tiền vé</span>
                            <strong>{money(stats.ticketRevenue)}</strong>
                        </div>
                        <div>
                            <span>Sản phẩm</span>
                            <strong>{money(stats.productRevenue)}</strong>
                        </div>
                    </div>
                    <div className="revenue-chart">
                        {data.revenueTrend.length === 0 ? (
                            ...
                            data.revenueTrend.map((item, index) => {
                                ...
                                const height = Math.max((revenue / maxRevenue) * 100, 4);
                                return (
                                    <div className="chart-column" key={`${item.date}-${index}`}>
                    ...
                    <div className="movie-ranking">
                        {data.topMovies.length === 0 ? (
                            ...
                            data.topMovies.map((movie, index) => (
                                <div className="movie-ranking-item" key={movie.id}>
                                    ...
                                    <div className="movie-info">
                                        ...
                                        <span>
                                            {movie.tickets_sold} vé • {movie.orders} đơn
                                        </span>
                                    </div>
                    ...
                    <div className="status-list">
                        {data.bookingStatus.length === 0 ? (
                            ...
                            data.bookingStatus.map((item, index) => {
                                const total = totalBookingStatus || 1;
                ...
                <div className="cinema-table">
                    ...
                    {data.cinemas.length === 0 ? (
                        ...
                        data.cinemas.map((cinema) => {
                            ...
                            const width = (revenue / maxCinemaRevenue) * 100;
                            return (
                                <div className="table-row" key={cinema.cinema_id}>
                    ...
                    <div className="room-list">
                        {data.rooms.length === 0 ? (
                            ...
                            data.rooms.slice(0, 8).map((room) => {
                                ...
                                const width = Math.min(occupancy, 100);
                                return (
                                    <div className="room-item" key={room.room_id}>
                                        <div className="room-info">
                                            <strong>{room.room_name}</strong>
                                            <span>
                                                {room.cinema_name} • {room.room_type}
                                            </span>
                                        </div>
                    ...
                    <div className="showtime-list">
                        {data.showtimes.length === 0 ? (
                            ...
                            data.showtimes.slice(0, 8).map((showtime) => (
                                <div className="showtime-item" key={showtime.showtime_id}>
                                    ...
                                    <div className="showtime-occupancy">
                                        <strong>{showtime.occupancy}%</strong>
                                        <span>
                                            {showtime.tickets} / {showtime.total_seats}
                                        </span>
                                    </div>
                                </div>
                            ))
                    ...
                    <div className="customer-list">
                        {data.topCustomers.length === 0 ? (
                            ...
                            data.topCustomers.map((customer, index) => (
                                <div className="customer-item" key={customer.user_id}>
                            ...
                            data.products.slice(0, 8).map((product) => (
                                <div className="product-item" key={product.product_id}>
                                    ...
                                    <div className="product-info">
                                        ...
                                        <span>
                                            {product.category} • {product.quantity} sản phẩm
                                        </span>
                                    </div>
                ...
                <div className="dashboard-card">
                    ...
                    <div className="growth-list">
                        {data.userGrowth.length === 0 ? (
                            ...
                            data.userGrowth.slice(-8).map((item) => (
                                <div className="growth-item" key={item.date}>
                                    <span>
                                        {new Date(item.date).toLocaleDateString('vi-VN', {
                                            day: '2-digit',
                                            month: '2-digit',
                                    ...
                                    <div className="growth-bar-wrap">
                                        <div
                                            ...
                                            style={{
                                                width: `${Math.min(Number(item.newUsers) * 10, 100)}%`,
                                            }}
                                        />
                                    </div>
                                    <strong>+{number(item.newUsers)}</strong>
                                </div>
                            ))
                        )}
                    </div>
            ...
            <section className="dashboard-card full-card">
                ...
                <div className="content-grid">
                    <ContentItem
                        ...
                        meta={content.movies ? `${content.movies.showing || 0} đang chiếu` : ''}
                    />
                    ...
                    <ContentItem
                        ...
                        meta={content.products ? `${content.products.active || 0} đang hoạt động` : ''}
                    />
                    <ContentItem
                        icon={<Activity />}
                        label="Blog"
                        value={content.blogs?.total}
                        meta={content.blogs ? `${content.blogs.active || 0} đang hoạt động` : ''}
                    />
                    ...
                    <ContentItem
                        ...
                        meta={content.reviews ? `${Number(content.reviews.averageRating).toFixed(1)} / 5` : ''}
                    />
            ...
            <section className="dashboard-grid grid-three">
                <div className="dashboard-card">
                    ...
                    <div className="review-list">
                        {data.reviews.slice(0, 7).map((movie) => (
                            <div className="review-item" key={movie.movie_id}>
                ...
                <div className="dashboard-card">
                    ...
                    <div className="coupon-list">
                        {data.coupons.slice(0, 7).map((coupon) => (
                            <div className="coupon-item" key={coupon.coupon_id}>
                                <div>
...
function KpiCard({ title, value, icon, iconClass, change, comparison, loading }) {
        ...
        <div className="kpi-card">
            <div className="kpi-top">
                ...
                {change !== null && change !== undefined && (
                    <div className={positive ? 'kpi-change positive' : 'kpi-change negative'}>
...
function CardHeader({ icon, title, subtitle }) {
    return (
        <div className="card-header">
            ...
            <ChevronDown size={18} className="card-more" />
        </div>
    );
}
