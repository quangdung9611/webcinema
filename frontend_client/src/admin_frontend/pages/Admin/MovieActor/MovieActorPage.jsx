...
const ASSIGNMENTS_API =
    'https://api.quangdungcinema.id.vn/api/movie-actors/all-assignments';

const UPDATE_API =
    'https://api.quangdungcinema.id.vn/api/movie-actors/update';
...
const MovieActorPage = () => {
    ...
    const handleCheckboxChange = (
        ...
        setMovieActorMap(prev => {
            ...
            const isSelected =
                currentActors.includes(actorId);
        ...
        try {
            ...
            await axios.post(
                UPDATE_API,
                {
                    ...
                    actor_ids:
                        movieActorMap[movie.movie_id] || []
                }
            );

            showAlert(
                'Thành công',
                `Đã cập nhật diễn viên cho phim "${movie.title}".`
            );
